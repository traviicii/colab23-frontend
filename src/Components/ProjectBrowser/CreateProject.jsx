...
export default function CreateProject({ chosenProject, closeModal }) {
    ...
    return (
        <div>
            ...
            <form onSubmit={() => setAreYouSure(true)}>
                ...
                <div className="p-6 space-y-2">
                    <div className="text-gray-700 font-bold">
                        <p>Which team members will be required on the team (not including yourself)?</p>
                        <div className='flex'>
                    ...
                    {areYouSure ?
                        ...
                        <div className='flex justify-center items-center shadow-2xl rounded-xl shadow-rose-400 w-[450px] h-[172px] px-4 py-8'>
                            ...
                            <div className=''>
                                ...
                                <button className='mt-2 w-full text-white focus:ring-4 focus:outline-none bg-[#ed4168]  font-medium rounded-lg text-sm px-5 py-2.5 text-center'>Launch it!</button>
