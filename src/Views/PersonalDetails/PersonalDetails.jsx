...
import { setFirstName, setLastName, setEmail, setLinkedIn, setPassword, setConfirmPassword, addToast } from '../../Actions';
...
export default function PersonalDetails() {
  ...
  const checkUser = async (e) => {
    ...
    if (formData.password != formData.confirmPassword) {
      dispatch(addToast("Your password isn't matching!", "error"))
      return
    }
    ...
    if (data.status === 'ok') {
      ...
      dispatch(addToast("A user with that email already exists. Please choose a different email to use.", "error"))
      // navigate('/signin')
    }
  }
