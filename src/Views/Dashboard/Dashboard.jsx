            ...
            <div className="flex justify-center mt-20">
                <div className="link-container flex">
                    ...
                    <div className="flex items-center justify-center mt-1">
                        ...
                        <p className="ml-4 text-2xl">Task</p>
                        </div>
                    </div>
                    ...
                    <div className={`tab-link ${activeDisplay === 'project-chat' ? 'active' : ''}`}
                        onClick={() => handleLinkClick('project-chat')}>
                        <div className="flex items-center justify-center mt-1">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Message">
                            <path id="Vector" d="M11.6667 15H26.6667M11.6667 21.6667H26.6667M11.6667 28.3334H20M36.6667 20C36.6667 29.205 29.205 36.6667 20 36.6667H3.33333V20C3.33333 10.795 10.795 3.33337 20 3.33337C29.205 3.33337 36.6667 10.795 36.6667 20Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </g>
                        </svg>

                        <p className="ml-4 text-2xl">Project Chat</p>
                        </div>
                    </div>
                </div>
            </div>
