...
export default function NewLinkModal({ isOpen, onClose, type, getResources }) {
    ...
    const createResource = async () => {
        ...
        const url = BACK_END_URL + `/api/createresource`
        const options = {
            method: "POST",
            headers: {
        ...
        try {
            ...
            console.log("Saving resource to database didnt work...")
          }
    }
