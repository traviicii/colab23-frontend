        ...
        <div className="h-screen pl-20 pt-20 mb-60">
            ...
            <div className="flex justify-center mt-20">
                <div className="link-container flex">
                    <div
                        className={`tab-link ${activeDisplay === 'task' ? 'active' : ''}`}
                        onClick={() => handleLinkClick('task')}
                    >
                        <p>Task</p>
                    </div>
                    <div
                        className={`tab-link ${activeDisplay === 'team' ? 'active' : ''}`}
                        onClick={() => handleLinkClick('team')}
                    >
                        <p>Team</p>
                    </div>
                    <div
                        className={`tab-link ${activeDisplay === 'resources' ? 'active' : ''}`}
                        onClick={() => handleLinkClick('resources')}
                    >
                        <p>Resources</p>
                    </div>
                    <div
                        className={`tab-link ${activeDisplay === 'project-chat' ? 'active' : ''}`}
