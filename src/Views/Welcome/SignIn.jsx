            ...
            <div className='border-box shadow-2xl shadow-slate-600 flex rounded-3xl h-3/5 w-3/4'>
                ...
                <div className='flex justify-center items-center flex-col h-full w-2/5'>
                    ...
                    <div className='flex justify-center items-center flex-col'>
                        <button onClick={newGoogleUser} className='flex items-center my-2 text-sm font-semibold border border-black rounded-md py-1.5 px-10 w-full'>
                        ...
                        <button className='flex items-center my-2 text-sm font-semibold border border-black rounded-md py-1.5 px-10 w-full'>
                            <svg className='mr-2' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
