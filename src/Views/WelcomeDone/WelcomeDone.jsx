...
export default function WelcomeDone() {
    ...
    return (
        <div className="professional-background-container h-screen" style={{ backgroundColor: '#bcbbc2' }}>
            <div className="flex items-center justify-center">
                <div className="shadow-2xl rounded-xl w-4/5 md:w-4/5 lg:w-3/5 xl:w-2/5 px-4 md:px-6 py-8 md:py-10 bg-white mb-60">
                    ...
                    <p className="text-md md:text-lg text-center font-semibold mb-12">
                        Thanks for sharing your details. Your profile is now ready.
                    </p>

                    <div className="flex items-center justify-between mt-6">
                        <button
                            className="w-full bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded-lg focus:outline-none"
                            type="button" style={{ backgroundColor: '#ed4168' }}
                            onClick={() => createNewUser()} >
                            Embark on Your TeamUp Journey!
                        </button>
                    </div>
